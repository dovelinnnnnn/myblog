        ...
        <div>
            ...
            <div id="show">
                <div class="clean-check" style="padding-left: 30px;">
                    ...
                    <label for="pb1"><span :style="'background:url('+radio[0]+') '+radio[1]+' top no-repeat;'"></span>Style 1</label>
...
export default {
  ...
  computed: {
    radio () {
      return [require('assets/images/check_radio_sheet.png'), '-57px']
    }
  },
  methods: {
    switcher () {
